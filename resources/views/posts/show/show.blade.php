...
<div class="container">
  ...
  <div class="row mb-5">
    <div class=" offset-1 col-10 d-flex">
      @if($before)
      <a class="text-dark mr-auto" href="/p/{{ $before->id }}"><i class="fas fa-lg fa-angle-double-left"></i>次の投稿</a>
      @endif
      @if($after)
      <a class="text-dark ml-auto" href="/p/{{ $after->id }}">前の投稿<i class="fas fa-lg fa-angle-double-right"></i></a>
      @endif
    </div>
  </div>
