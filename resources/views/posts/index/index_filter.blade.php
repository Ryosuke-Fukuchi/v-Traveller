...
<div class="container">
  ...
  <div class="row">
    <div class="offset-9 col-2" style="position: fixed; top: 150px; left: 0;">
      ...
      <div class="">
        @if(isset($category))<h3 class="py-2"><i class="fas fa-hashtag pr-2"></i>{{$category->name}}</h3>@endif
        @if(isset($prefecture))<h3 class="py-2"><i class="fa fa-map-marked-alt pr-2"></i>{{$prefecture->pre}}</h3>@endif
        @if(isset($keywords))
        <h4 class="py-2">
          <i class="fas fa-lg fa-search-plus pr-1"></i>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select id="category" name="category" class="form-control" @if(isset($category)) data-index="{{$category->id}}" @endif>
        ...
        <div class="form-group">
          ...
          <select id="prefecture" name="prefecture" class="form-control" @if(isset($prefecture)) data-index="{{$prefecture->id}}" @endif>
