    ...
    <div class="row">
      <div class="col-9 offset-1">
        ...
        <div class="form-group row">
          ...
          <textarea id="caption" name="caption" class="form-control @error('caption') is-invalid @enderror" autocomplete="caption" placeholder="アルバムの説明">{{ old('caption') }}</textarea>
        ...
        <div class="row pt-5">
          <button class="btn btn-primary">Create New Album</buttom>
        </div>
